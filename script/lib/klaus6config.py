...
class TVirtualConfig:
    def __init__(self):
        ...
        self.parameters.append(_parameter("digital/i2c_address",                     66,     0, "Unused, I2C slave address (7-bit)"))
        self.parameters.append(_parameter("digital/debug_pad_enable",                66+7,   0, "Enable digital debug pad (Not Connected)"))
        self.parameters.append(_parameter("digital/i2c_readout_enable",              66+8,   0, "Enable LVDS readout mode"))
        self.parameters.append(_parameter("digital/LVDS_serdata_tx_iDAC",            75,     0, "LVDS output pad current setting. 8-bit"))
        self.parameters.append(_parameter("digital/LVDS_serdata_tx_vcmDAC",          83,     0, "LVDS output pad common mode voltage setting. 6-bit"))
